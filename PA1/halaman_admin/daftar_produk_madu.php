...
<body>
    ...
    <main class="mt-5 pt-3">
       <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 fw-bold fs-3 text-center text-light">Data Checkout Madu Mauas JKM</div> 
          </div>
  ...
  <tbody>
    <?php
        require '../config.php';
        $data = mysqli_query($conn,"SELECT * FROM checkout_produk WHERE nama_produk = 1");
        $No = 1;
...
<a href="checkout_pemesanan.php" class="btn btn-success">Kembali</a>
</div>
</div>
</div>
</div>
