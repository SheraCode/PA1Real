...
<body>
       ...
       <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header text-center">
                <h3><b>Jawab Pertanyaan Produk Mauas JKM</b></h3>
            </div>
            <div class="card-body">
            <form action="jawab_madu_process.php" method="post" enctype="multipart/">
                <?php 
                $no = 1;
                $id = $_GET['id'];
    require '../config.php';
    ...
    ?>
                <div class="mb-3">
                    <input type="hidden" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="no" value="<?php echo $no++?>">
                    </div>
                <fieldset disabled>
                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Nama Lengkap</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="nama_lengkap" value="<?php echo $pertanyaan['nama_lengkap']?>">
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputPassword1" class="form-label">Pertanyaan</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" name="pertanyaan" value="<?php echo $pertanyaan['pertanyaan']?>">
                    </div>
                </fieldset>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Jawaban</label>
                      <div class="form-floating">
                        <textarea class="form-control" id="floatingTextarea" name="jawaban"></textarea>
                    </div>
                    </div>
</div>
<input type="hidden" name="id" value="<?php echo $pertanyaan['id_pertanyaan']?>">
  <button type="submit" class="btn btn-primary m-3 p-1"><b>Kirim</b></button>
</form>
