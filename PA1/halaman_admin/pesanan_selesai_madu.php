...
<body>
    ...
    <main class="mt-5 pt-3">
       <div class="container-fluid">
          <div class="row">
          <div class="col-md-12 fw-bold fs-3 text-center text-light">Data Konfirmasi Pesanan Selesai Produk Madu Mauas JKM</div> 
          </div>
  ...
  <tbody>
    <?php 
    require '../config.php';
    $data = mysqli_query($conn,"SELECT * FROM checkout_produk WHERE nama_produk = 1 AND status_bayar = 'Pesanan Dikirim'");
    $no = 1;
    foreach($data as $madu) {
    ?>
    <tr class="bg-secondary">
      <th scope="row"><?php echo $no++?></th>
      <td><?php echo $madu['username'];?></td>
      <td>
        <a href="konfirmasi_selesai_madu.php?id=<?= $madu['id_checkout']?>" class="btn btn-warning"><b>Konfirmasi Pesanan Selesai</b></a>
      </td>
    </tr>
    <?php }?>
  </tbody>
