...
<body>
    ...
    <main class="mt-5 pt-3">
       <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 fw-bold fs-3 text-center text-light">Produk Sambal Teri Andaliman</div> 
<div class="container">
<!-- Mulai dari sini -->
<div class="container">
    <div class="card">
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        $gambar = $row['gambar'];
        ?>
        <form action="edit_teman_process.php" method="post" enctype="multipart/form-data">
