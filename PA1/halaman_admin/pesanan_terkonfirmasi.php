...
<body>
    ...
    <main class="mt-5 pt-3">
       <div class="container-fluid">
          <div class="row">
          <div class="col-md-12 fw-bold fs-3 text-center text-light">Data Pemesanan Terkonfirmasi Mauas JKM</div> 
          </div>
  ...
  <div class="card-body">
    ...
    Madu Mauas</b></h5>
    <p class="card-text">Data dibawah adalah data Pesanan Terkonfirmasi. </p>
    <?php 
        require '../config.php';
    ...
    ?>
    <a href="terkonfirmasi_madu.php"class="btn btn-primary"><?php echo $count1?> Produk</a>
  </div>
</div>
    </div>
    <div class="col">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Data dibawah adalah data Pesanan Terkonfirmasi.</p>
    <a href="terkonfirmasi_cookies.php" class="btn btn-primary"><?php echo $count2?> Produk</a>
  </div>
</div>
    </div>
    <div class="col">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Data dibawah adalah data Pesanan Terkonfirmasi.</p>
    <a href="terkonfirmasi_teman.php" class="btn btn-primary"><?php echo $count3?> Produk</a>
  </div>
</div>
    </div>
  </div>
