...
<body>
  ...
  <tbody>
    <?php 
    require '../config.php';
    $data = mysqli_query($conn,"SELECT * FROM checkout_produk WHERE nama_produk = 3 AND status_bayar = 'Terkonfirmasi'");
    $no = 1;
    ...
    <tr class="bg-secondary">
      ...
      <td>
        <a href="konfirmasi_pengiriman_teman.php?id=<?= $madu['id_checkout']?>" class="btn btn-warning"><b>Kirim Pesanan</b></a>
      </td>
    </tr>
    <?php }?>
  </tbody>
