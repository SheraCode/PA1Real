...
<body>
    ...
    <main class="mt-5 pt-3">
       <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 fw-bold fs-3 text-center text-light">Data Pesanan Terkonfirmasi Produk Cookies Mauas JKM</div> 
          </div>
  ...
  <tbody>
    <?php 
    require '../config.php';
    $data = mysqli_query($conn,"SELECT * FROM checkout_produk INNER JOIN akun ON checkout_produk.akun_id = akun.id_akun WHERE nama_produk = 2 AND status_bayar = 'Terkonfirmasi'");
    $no = 1;
