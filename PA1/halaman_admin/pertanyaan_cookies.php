...
<body>
    ...
    <main class="mt-5 pt-3">
       <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 fw-bold fs-3 text-center text-light">Pertanyaan Produk Cookies Mauas JKM</div> 
<div class="container">
  <div class="card">
    <div class="card-body">
    <table class="table">
  ...
  <tbody >
    <?php 
    require '../config.php';
      $data = mysqli_query($conn,"SELECT * FROM ((pertanyaan INNER JOIN produk ON pertanyaan.id_produk = produk.id_produk)INNER JOIN akun ON akun.id_akun = pertanyaan.id_user) WHERE jawaban = '' AND pertanyaan.id_produk = 2");
      $no = 1;
      foreach($data as $pertanyaan) {
    ?>
    <tr class="bg-secondary text-light">
      <th><?php echo $no++ ?></th>
      <td scope="row"><?php echo $pertanyaan['nama_lengkap']?></td>
      <td><?php echo $pertanyaan['pertanyaan']?></td>
      <td>
        <a href="jawab_madu.php?id=<?php echo $pertanyaan['id_pertanyaan']?>" class="btn btn-warning"><b>Jawab</b></a>
      </td>
    </tr>
    <?php } ?>
  </tbody>
