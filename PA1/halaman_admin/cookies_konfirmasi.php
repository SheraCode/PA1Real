...
<body>
    ...
    <main class="mt-5 pt-3">
       <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 fw-bold fs-3 text-center text-light">Data Konfirmasi Pembayaran Produk Cookies Mauas JKM</div> 
          </div>
  ...
  <tbody>
    <?php 
    require '../config.php';
    $data = mysqli_query($conn,"SELECT * FROM checkout_produk WHERE nama_produk = 2 AND status_bayar = 'Menunggu Konfirmasi'");
    $no = 1;
    ...
    <tr>
      ...
      <td>
        <a href="konfirmasi_pembayaran_cookies.php?id=<?= $cookies['id_checkout']?>" class="btn btn-success"><b>Konfirmasi</b></a>
      </td>
    </tr>
    <?php }?>
  </tbody>
