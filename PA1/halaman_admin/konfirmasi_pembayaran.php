...
<body>
    ...
    <main class="mt-5 pt-3">
       <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 fw-bold fs-3 text-center text-light">Data Konfirmasi Pesanan</div> 
          </div>
...
$data = mysqli_query($conn, "SELECT * FROM checkout_produk INNER JOIN akun ON akun.id_akun = checkout_produk.akun_id WHERE status_bayar = 'Menunggu Konfirmasi'");
while ($d = mysqli_fetch_array($data)) {
    ...
    <tr>
        ...
        <td>
          <a href="konfirmasi_pembayaran_madu_process.php?id=<?= $d['id_checkout']?>" class="btn btn-success">Terima</a>
          <a href="batal_konfirmasi.php?id=<?php echo $d['id_checkout']?>" class="btn btn-danger">Tolak</a>
        </td>
    </tr>
<?php } ?>
