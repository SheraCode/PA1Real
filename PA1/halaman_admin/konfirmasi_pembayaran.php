ata Dibawah ini Adalah Data Konfirmasi Pembayaran Pesanan Customer<?php
    session_start();
...
<body>
          ...
          <nav class="navbar-dark">
            ...
            <li>
              ...
              <div class="collapse" id="collapseExample">
                <div>
                 <ul class="navbar-nav ps-3">
                    <a href="konfirmasi_pembayaran.php" class="nav-link px-3  active">
                      <span class="me-2">
                        <i class="bi bi-layout-split"></i>
                      </span>
    ...
    <main class="mt-5 pt-3">
       <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 fw-bold fs-3 text-center text-light">Data Pemesanan Produk Mauas JKM</div> 
          </div>
  ...
  <div class="card-body">
    ...
    Madu Mauas</b></h5>
    <p class="card-text">Data Dibawah ini Adalah Data Konfirmasi Pembayaran Pesanan Customer </p>
    <?php 
        require '../config.php';
        $data1 = mysqli_query($conn,"SELECT * FROM checkout_produk WHERE status_bayar = 'Menunggu Konfirmasi' AND nama_produk=1");
        $count1 = mysqli_num_rows($data1);
        $data2 = mysqli_query($conn,"SELECT * FROM checkout_produk WHERE status_bayar = 'Menunggu Konfirmasi' AND nama_produk=2");
        $count2 = mysqli_num_rows($data2);
        $data3 = mysqli_query($conn,"SELECT * FROM checkout_produk WHERE status_bayar = 'Menunggu Konfirmasi' AND nama_produk=3");
        $count3 = mysqli_num_rows($data3);

    ?>
    <a href=
    "konfirmasi_madu.php"class="btn btn-warning" id="madumauas" onclick="madumauas()"><b><?php echo $count1?> Produk</b></a>
  </div>
</div>
    </div>
    <div class="col">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Data Dibawah ini Adalah Data Konfirmasi Pembayaran Pesanan Customer</p>
    <a href="cookies_konfirmasi.php" class="btn btn-warning"><b><?php echo $count2?> Produk</b></a>
  </div>
</div>
    </div>
    <div class="col">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Data Dibawah ini Adalah Data Konfirmasi Pembayaran Pesanan Customer</p>
    <a href="teman_konfirmasi.php"class="btn btn-warning"><b><?php echo $count3?> Produk</b></a>
  </div>
</div>
    </div>
  </div>
