...
<div class="container">
  ...
  <tbody >
    <?php 
    require '../config.php';
      $data = mysqli_query($conn,"SELECT * FROM ((pertanyaan INNER JOIN produk ON pertanyaan.id_produk = produk.id_produk)INNER JOIN akun ON akun.id_akun = pertanyaan.id_user) WHERE jawaban = '' AND pertanyaan.id_produk = 1");
      $no = 1;
