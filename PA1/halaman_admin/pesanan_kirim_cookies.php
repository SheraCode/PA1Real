...
<body>
    ...
    <main class="mt-5 pt-3">
       <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 fw-bold fs-3 text-center text-light">Data Konfirmasi Pengiriman Produk Madu Mauas JKM</div> 
          </div>
  ...
  <tbody>
    <?php 
    require '../config.php';
    $data = mysqli_query($conn,"SELECT * FROM checkout_produk WHERE nama_produk = 2 AND status_bayar = 'Terkonfirmasi'");
    $no = 1;
    ...
    <tr class="bg-secondary">
      ...
      <td>
        <a href="konfirmasi_pengiriman_cookies.php?id=<?= $madu['id_checkout']?>" class="btn btn-warning"><b>Kirim Pesanan</b></a>
      </td>
    </tr>
    <?php }?>
  </tbody>
