        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                    ...
                    require 'config.php';
                    $id = $_GET['id'];
                    $data = mysqli_query($conn,"SELECT * FROM ((pertanyaan INNER JOIN produk ON pertanyaan.id_produk = produk.id_produk) INNER JOIN akun ON akun.id_akun = pertanyaan.id_user)WHERE id_pertanyaan = '$id' ");
                    while($row = mysqli_fetch_array($data))
                 {?>
                        <h2 class="text-center"><b>Pertanyaan</b></h2>
                    <!-- form pembelian -->
    <form action="bayar_sekarang_process.php" method="post" enctype="multipart/form-data">
        <fieldset disabled>

          <div class="mb-3">
            <label for="disabledTextInput" class="form-label"><b>nama lengkap</b></label>
            <input type="text" id="disabledTextInput" class="form-control" value="<?php echo $row['nama_lengkap']?>">
          </div>
          <div class="mb-3">
            <label for="disabledTextInput" class="form-label"><b>Pertanyaan Produk</b></label>
            <input type="text" id="disabledTextInput" class="form-control"  value="<?php echo $row['pertanyaan']?>">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            <label for="disabledTextInput" class="form-label"><b>Jawaban</b></label>
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="alamat" value="" placeholder="Belum Ada Jawaban"><?php echo $row['jawaban']?></textarea>
          </div>
        </fieldset>
        <a href="profile_user.php" class="btn btn-success m-2">Kembali</a>
