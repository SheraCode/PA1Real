...
<head>
    ...
    <!-- Site Metas -->
    <title>Check Out Madu Mauas</title>
...
?>
    ...
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Check Out Madu Mauas</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="product.php">Product</a></li>
                        <li class="breadcrumb-item active">Check Out Madu Mauas</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                    ...
                    <form action="checkout_process.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="exampleFormControlInput1" name="quantity" value="<?php echo $_POST['Quantity']?>" >
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="price-box-bar">
                                <div class="cart-and-bay-btn">
                                    <button class="btn hvr-hover mt-3 text-light" id="btn" data-fancybox-close="" ><b>Beli Sekarang</b></button>
                                </div>
                            </div>
