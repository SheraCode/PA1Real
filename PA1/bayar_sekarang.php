                ...
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="asset/mandirijernikartika.jpg" alt="First slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="asset/mandirijernikartika.jpg" alt="Second slide"> </div>
                            <div class="carousel-item "> <img class="d-block w-100" src="asset/mandirijernikartika.jpg" alt="First slide"> </div>
                        </div>
    ...
    <tr class="bg-secondary">
      ...
      <img src="buktibayar/<?php echo $row['bukti_bayar'];?>" alt="" width="150px;">
        ...
        <div class="mb-3">
          ...
          <button class="btn btn-success text-decoration-none m-1 p-2"><b><?php echo $row['status_bayar']; ?></b></button>
          <a href="cekongkir.php" class="btn btn-danger"><b>Cek Ongkir</b></a>
                          <?php }?>
                              </div>
    </form>
                    </div>
