...
<body style="background-color:#F8F8FF">
    ...
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Pertanyaan produk Madu</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="product.php">Product</a></li>
                        <li class="breadcrumb-item active">Pertanyaan produk madu</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <fieldset disabled>
          ...
          <div class="mb-3">
            <label for="disabledTextInput" class="form-label"><b>Pertanyaan</b></label>
            <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="pesan" value=<?php echo $madup ['pertanyaan']; ?>></textarea>     
          </div>
          <div class="mb-3">
            <label for="disabledTextInput" class="form-label"><b>Nama Produk</b></label>
            <input type="text" id="disabledTextInput" class="form-control" value="Madu" >
          </div>
          <div class="mb-3">
            <label for="disabledTextInput" class="form-label"><b>Pertanyaan</b></label>
            <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="pesan" aria-placeholder="Belum Ada Jawaban">{{ $data->jawaban }}</textarea>     
          </div>
        </fieldset>                          
        <a href="/home" class="btn btn-danger mb-4"><b>Kembali</b></a>
                              </div>
    </form>
                    </div>
                </div>
