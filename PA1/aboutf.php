    ...
    <div class="categories-shop">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="asset/bankbri.png" alt="" />
                        <a class="btn hvr-hover" href="javascript:void()" id="bri" onclick="bri()">Bank Rakyat Indonesia</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="asset/mandiri.png" alt="" />
                        <a class="btn hvr-hover" href="#">Bank Mandiri</a>
                    </div>
                    <div id="bri" class="mt-2">
    
                    <script>
                            function bri() {
                            $.get("bri.php", function(data) {
                            $("#bri").html(data);
                        });
                    }
                    </script>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="asset/bca.png" alt="" />
                        <a class="btn hvr-hover" href="#">Bank Central Asia</a>
                    </div>
                </div>
            </div>
        </div>
