...
if ($fileError === UPLOAD_ERR_OK) {
    ...
    if (in_array(strtolower($fileExt), $allowedExtensions)) {
        ...
        echo "<script>alert('File yang diunggah harus dalam format JPEG, JPG, atau PNG.'); window.location.href = 'cekongkir.php';</script>";
    }
} else {
    echo "<script>alert('Terjadi kesalahan saat mengunggah gambar lampiran keranjang'); window.location.href = 'cekongkir.php';</script>";
}
?>
